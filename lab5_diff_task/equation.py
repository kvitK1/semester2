...
from classes_for_eq import Polynomial, Quadratic


def testPolynomialBasics():
    """Testing Polynomial class basics."""
...
def testPolynomialEq():
    """Testing Polynomial class equatation method."""
...
def testPolynomialConstructor():
    """Testing Polynomial class constructor."""
...
def testPolynomialInSets():
    """Testing Polynomial class occurance in sets."""
    s = set()
...
def testPolynomialMath():
    """Testing Polynomial class math operations."""
    p1 = Polynomial([2, -3, 5])  # 2x**2 -3x + 5
...
def testPolynomialClass():
    """Testing all Polynomial class tests."""
...
def testQuadraticClass():
    """Testing Quadratic Polynomial class."""
    import math
